...
python main.py AIR --dataset LongTailedCIFAR-100 --base-ratio 0.1 --phases 9
 --data-root ~/dataset --batch-size 256 --num-workers 16 --backbone resnet32 --learning-rate 0.5 --label-smoothing 0 --base-epochs 300 --weight-decay 5e-4 --gamma 0.1 --buffer-size 1024 --cache-features --IL-batch-size 4096


 python main.py DSIR2 --dataset LongTailedCIFAR-100 --base-ratio 0.1 --phases 9
 --data-root ~/dataset --batch-size 256 --num-workers 16 --backbone resnet32 --learning-rate 0.5 --label-smoothing 0 --base-epochs 300 --weight-decay 5e-4 --gamma 0.1 --gamma-comp 0.1 --compensation-ratio 0.6 --buffer-size 1024 --cache-features --IL-batch-size 4096 --gpu 1


 python main.py AIR --dataset LongTailedCIFAR-100 --base-ratio 0.1 --phases 9
 --data-root ~/dataset --batch-size 256 --num-workers 16 --backbone vit_b_16 --learning-rate 0.5 --label-smoothing 0  --gamma 0.1 --buffer-size 2048 --cache-features --IL-batch-size 4096


 python main.py DSIR2 --dataset LongTailedCIFAR-100 --base-ratio 0.1 --phases 9
 --data-root ~/dataset --batch-size 256 --num-workers 16 --backbone vit_b_16 --learning-rate 0.5 --label-smoothing 0  --gamma 0.1 --gamma-comp 0.1 --compensation-ratio 0.6 --buffer-size 2048 --cache-features --IL-batch-size 4096



 python main.py AIR --dataset ham10000 --base-ratio 0.42 --phases 4
 --data-root ~/dataset --batch-size 32 --num-workers 16 --backbone resnet32 --learning-rate 0.5 --label-smoothing 0 --base-epochs 100 --weight-decay 5e-4 --gamma 0.1 --buffer-size 1024 --cache-features --IL-batch-size 4096
 ...
 python main.py AIR --dataset LongTailedCIFAR-100 --base-ratio 0.1 --phases 9 --data-root ~/dataset --batch-size 256 --num-workers 16 --backbone resnet32 --learning-rate 0.5 --label-smoothing 0 --base-epochs 300 --weight-decay 5e-4 --gamma 0.1 --buffer-size 2048 --cache-features --IL-batch-size 4096 --gpu 1# DSIR
# DSIR
