...
from .AnalyticLinear import AnalyticLinear, RecursiveLinear,GeneralizedARM2
from .Buffer import activation_t, RandomBuffer
from torch._prims_common import DeviceLikeType


class DSIR2(torch.nn.Module):
    def __init__(
        self,
        backbone_output: int,
        ...
        device=None,
        dtype=torch.double,
        linear: type[AnalyticLinear] = GeneralizedARM2,
    ) -> None:
        super().__init__()
...
class DSIR2Learner(ACILLearner):
    def __init__(
        self,
        args: Dict[str, Any],
