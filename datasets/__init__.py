...
from .CIFAR import LongTailedCIFAR100_ as LongTailedCIFAR100
...
dataset_list = {
    ...
    "LongTailedCIFAR-100": LongTailedCIFAR100,
}
...
def load_dataset(
    ...
    *args,
    **kwargs
) -> Union[MNIST, CIFAR10, CIFAR100, ImageNet, LongTailedCIFAR100]:
